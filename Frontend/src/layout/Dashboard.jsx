    ...
    return (
        <div className='md:flex md:min-h-screen'>
            ...
            <div className='md:w-1/5 bg-gray-800 px-5 py-4'>
                ...
                <h2 className='text-4xl font-black text-center text-slate-200'>Wraith</h2>
                ...
                <p className='text-slate-400 text-center my-4 text-sm'> {user?.rol} </p>
            ...
            <div className='flex-1 flex flex-col justify-between h-screen bg-gray-100'>
                <div className='bg-gray-900 py-2 flex md:justify-end items-center gap-5 justify-center'>
